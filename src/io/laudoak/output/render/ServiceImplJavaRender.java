 ...
 */
public class ServiceImplJavaRender extends AbRender {
    public ServiceImplJavaRender(List<TableModel> tables, TypeMapper typeMapper, Config cnf) {
    ...
    public void render() {
        ...
        for (BeanModel model : beans) {
            ...
            String value = engine.process(map, "ServiceImpl.java.vm");
            out(structure.getServiceImplPath(), model.getName() + "ServiceImpl.java", value);
        }
    }
}
