...
{
    public ServiceImplGenerator(Naming naming, TypeMapper typeMapper, String projectName, String packageName, List<Table> tables, DBStarter dbStarter)
    {
    ...
    public void export()
    {
        ...
        for (Bean bean : beans)
        {
            ...
            String mapperValue = TplEngine.instance().process(map, "ServiceImpl.vm");
            write(structure.getServiceImplPath(), bean.getName() + "ServiceImpl.java", mapperValue);
        }
    }
}
